...
const useCardInformation = () => {
  const [cardState, dispatch] = reactExports.useReducer(reducer$1, initialCardInfo$1);
  const allComplete = () => {
...
const PreviewCard = ({
  ...
  return /* @__PURE__ */ jsxs("div", { css: previewCardStyle(cardIssuer[0]), children: [
...
const previewCardStyle = (cardIssuer) => css`
  width: 212px;
  height: 132px;
  border-radius: 4px;
  background-color: ${cardColor[cardIssuer]};
...
const isSameLength = (v, maxLength) => {
  if (v.length === maxLength) {
    return true;
  }
  return false;
};
const isTypeNumber = (v) => {
  if (/^[0-9]*$/.test(v)) {
    return true;
  }
  return false;
};
const setErrorTrue = (type, index, dispatchError) => {
  dispatchError({ type, index, value: true });
};
const setErrorFalse = (type, index, dispatchError) => {
...
const UniqueNumberForm = ({ uniqueNumberState, dispatch, errorState, dispatchError }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { css: FormSectionWrapperStyle$4, children: [
    /* @__PURE__ */ jsxs("div", { css: TextWrapperStyle$4, children: [
    ...
    /* @__PURE__ */ jsxs("div", { css: inputFieldStyle$4, children: [
      /* @__PURE__ */ jsx$1(Text, { text: label, size: "12px", color: "#0a0d13", weight: 500, lineHeight: "15px" }),
      /* @__PURE__ */ jsx$1("div", { css: inputWrapperStyle$3, children: Array.from({ length: inputNumber }).map((_, index) => {
      ...
      /* @__PURE__ */ jsx$1("div", { css: errorTextWrapperStyle$3(errorState.some((bool) => bool === true)), children: /* @__PURE__ */ jsx$1(Text, { text: errorMessage, size: "9.5px", color: "#ff3d3d", weight: 400, lineHeight: "normal" }) })
    ] })
  ] });
};
const inputWrapperStyle$3 = css`
  gap: 10px;
  width: 100%;
  display: flex;
`;
const inputFieldStyle$4 = css`
  width: 100%;
  display: flex;
  flex-direction: column;
  gap: 8px;
`;
const errorTextWrapperStyle$3 = (error) => css`
  opacity: ${error ? "1" : "0"};
  height: 5px;
`;
const TextWrapperStyle$4 = css`
  display: flex;
  flex-direction: column;
  gap: 4px;
`;
const FormSectionWrapperStyle$4 = css`
  display: flex;
  flex-direction: column;
  gap: 16px;
`;
...
const ExpirationDateForm = ({ expirationDateState, dispatch, errorState, dispatchError }) => {
  const inputRefs = useInputFocus();
  const { errorMessage, handleChange } = useExpirationDate({ dispatch, dispatchError, inputRefs });
  return /* @__PURE__ */ jsxs("div", { css: FormSectionWrapperStyle$3, children: [
    /* @__PURE__ */ jsxs("div", { css: TextWrapperStyle$3, children: [
    ...
    /* @__PURE__ */ jsxs("div", { css: inputFieldStyle$3, children: [
      /* @__PURE__ */ jsx$1(Text, { text: inputFieldData.label, size: "12px", color: "#0a0d13", weight: 500, lineHeight: "15px" }),
      /* @__PURE__ */ jsx$1("div", { css: inputWrapperStyle$2, children: Array.from({ length: inputFieldData.inputNumber }).map((_, index) => {
      ...
      /* @__PURE__ */ jsx$1("div", { css: errorTextWrapperStyle$2(errorState[0] || errorState[1]), children: /* @__PURE__ */ jsx$1(Text, { text: errorMessage, size: "9.5px", color: "#ff3d3d", weight: 400, lineHeight: "normal" }) })
    ] })
  ] });
};
...
const errorTextWrapperStyle$2 = (error) => css`
  ...
  height: 5px;
`;
const TextWrapperStyle$3 = css`
  display: flex;
  flex-direction: column;
  gap: 4px;
`;
const FormSectionWrapperStyle$3 = css`
  display: flex;
  flex-direction: column;
  gap: 16px;
`;
...
const CvcNumberForm = ({ cvcNumberState, dispatch, errorState, dispatchError }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { css: FormSectionWrapperStyle$2, children: [
    ...
    /* @__PURE__ */ jsxs("div", { css: inputFieldStyle$2, children: [
      /* @__PURE__ */ jsx$1(Text, { text: label, size: "12px", color: "#0a0d13", weight: 500, lineHeight: "15px" }),
      /* @__PURE__ */ jsx$1("div", { css: inputWrapperStyle$1, children: /* @__PURE__ */ jsx$1(
        Input,
        {
      ...
      /* @__PURE__ */ jsx$1("div", { css: errorTextWrapperStyle$1(errorState[0]), children: /* @__PURE__ */ jsx$1(Text, { text: errorMessage, size: "9.5px", color: "#ff3d3d", weight: 400, lineHeight: "normal" }) })
    ] })
  ] });
};
...
const PasswordForm = ({ passwordState, dispatch, errorState, dispatchError }) => {
  const { title: title2, description: description2, inputFieldData: inputFieldData2 } = passwordSpec;
  const { label, inputProps } = inputFieldData2;
  const { placeholder, maxLength } = inputProps;
  const inputRefs = useInputFocus();
  ...
  return /* @__PURE__ */ jsxs("div", { css: FormSectionWrapperStyle$1, children: [
    ...
    /* @__PURE__ */ jsxs("div", { css: inputFieldStyle$1, children: [
      ...
      /* @__PURE__ */ jsx$1("div", { css: errorTextWrapperStyle(errorState[0]), children: /* @__PURE__ */ jsx$1(Text, { text: errorMessage, size: "9.5px", color: "#ff3d3d", weight: 400, lineHeight: "normal" }) })
    ] })
  ] });
};
...
const FormSectionWrapperStyle$1 = css`
  ...
  gap: 16px;
`;
const cardIssuerSpec = {
  title: "카드사를 선택해 주세요",
  description: "현재 국내 카드사만 가능합니다.",
  optionList: ["BC카드", "신한카드", "카카오뱅크", "현대카드", "우리카드", "롯데카드", "하나카드", "국민카드"]
};
const Select = ({ optionList, value, setValue }) => {
  const [dropdownOpen, setdropdownOpen] = reactExports.useState(false);
  const toggleDropdownOpen = () => setdropdownOpen((prev2) => !prev2);
  const closeDropdown = () => setdropdownOpen(false);
  const handleOption = (v) => {
    setValue(v);
    setdropdownOpen(false);
  };
  return /* @__PURE__ */ jsxs("div", { tabIndex: 0, onBlur: closeDropdown, css: selectBoxStyle, children: [
    /* @__PURE__ */ jsxs("div", { css: selectedValueStyle(dropdownOpen), onClick: toggleDropdownOpen, children: [
      /* @__PURE__ */ jsx$1("div", { css: selectedValueTextStyle(Boolean(value)), children: value ?? "선택해 주세요." }),
      /* @__PURE__ */ jsx$1("img", { css: iconStyle, src: dropdownOpen ? "chevron-down.svg" : "chevron-up.svg" })
    ] }),
    dropdownOpen && /* @__PURE__ */ jsx$1("ul", { css: optionListStyle, children: optionList.map((opt, idx) => /* @__PURE__ */ jsx$1("li", { css: optionStyle, onClick: () => handleOption(opt), children: opt }, idx)) })
  ] });
};
const selectBoxStyle = css`
  ...
  margin-bottom: 10px;
`;
const selectedValueStyle = (dropdowndropdownOpen) => css`
  width: 100%;
  height: 100%;
  display: flex;
  justify-content: space-between;
  ...
  cursor: pointer;
`;
const selectedValueTextStyle = (isSelected) => css`
  font-size: 11px;
...
const optionStyle = css`
  ...
  cursor: pointer;
`;
const CardIssuerForm = ({ cardIssuerState, dispatch }) => {
  const { title: title2, description: description2, optionList } = cardIssuerSpec;
  return /* @__PURE__ */ jsxs("div", { css: FormSectionWrapperStyle, children: [
    /* @__PURE__ */ jsxs("div", { css: TextWrapperStyle, children: [
      /* @__PURE__ */ jsx$1(Text, { text: title2, size: "18px", color: "#000", weight: 700, lineHeight: "normal" }),
      /* @__PURE__ */ jsx$1(Text, { text: description2, size: "9.5px", color: "#8b95a1", weight: 400, lineHeight: "normal" })
    ] }),
    /* @__PURE__ */ jsx$1("div", { css: inputFieldStyle, children: /* @__PURE__ */ jsx$1(
      Select,
      {
        value: cardIssuerState[0],
        setValue: (value) => dispatch({ type: "SET_CARD_ISSUER", value }),
        optionList
      }
    ) })
  ] });
...
const FormSectionWrapperStyle = css`
  ...
  gap: 16px;
`;
const Button = ({ text, disabled = false, onClick, rounded = false }) => {
  return /* @__PURE__ */ jsx$1("button", { css: buttonStyle(rounded), disabled, onClick, children: text });
};
const buttonStyle = (rounded) => css`
  width: 100%;
  height: 44px;
...
const useOpenForm = ({
  ...
  const [openForm, setOpenForm] = reactExports.useState(OPEN_SEQUENCE.map((_) => false));
  const openNextForm = (currentForm) => {
    const currentFormSequence = OPEN_SEQUENCE.indexOf(currentForm);
    setOpenForm((prev2) => prev2.map((openForm2, sequence) => sequence === currentFormSequence + 1 ? true : openForm2));
  };
  const isFormOpen = (form) => {
    const sequence = OPEN_SEQUENCE.indexOf(form);
    return openForm[sequence];
  };
  const checkNextFormOpen = (currentForm) => {
...
const useCardError = () => {
  const [cardErrorState, dispatchError] = reactExports.useReducer(reducer, initialCardInfo);
  const allClear = () => {
...
function CardFormPage() {
  ...
  const { cardErrorState, dispatchError, allClear, uniqueNumberClear, expirationDateClear, cvcNumberClear } = useCardError();
  ...
  return /* @__PURE__ */ jsx$1("div", { children: /* @__PURE__ */ jsxs("div", { css: AppStyle$1, children: [
    /* @__PURE__ */ jsx$1(
      PreviewCard,
      {
    ...
    /* @__PURE__ */ jsxs("div", { css: FormContainerStyle, children: [
      isFormOpen("password") && /* @__PURE__ */ jsx$1(
        PasswordForm,
        {
      ...
      isFormOpen("cvcNumber") && /* @__PURE__ */ jsx$1(
        CvcNumberForm,
        {
      ...
      isFormOpen("expirationDate") && /* @__PURE__ */ jsx$1(
        ExpirationDateForm,
        {
      ...
      isFormOpen("cardIssuer") && /* @__PURE__ */ jsx$1(CardIssuerForm, { cardIssuerState: cardIssuer, dispatch, openNextForm }),
      /* @__PURE__ */ jsx$1(
        UniqueNumberForm,
        {
    ...
    isFormOpen("password") && allComplete() && allClear() && /* @__PURE__ */ jsx$1("div", { css: ButtonContainerStyle, children: /* @__PURE__ */ jsx$1(Button, { text: "확인", onClick: handleButtonClick }) })
  ] }) });
}
const AppStyle$1 = css`
  width: 376px;
...
function App() {
  return /* @__PURE__ */ jsx$1(HashRouter, { children: /* @__PURE__ */ jsxs(Routes, { children: [
    /* @__PURE__ */ jsx$1(Route, { path: "/", element: /* @__PURE__ */ jsx$1(CardFormPage, {}) }),
    /* @__PURE__ */ jsx$1(Route, { path: "/complete", element: /* @__PURE__ */ jsx$1(CardResistrationCompletePage, {}) })
  ] }) });
}
